...
namespace AntigravityEditor
{
    ...
    public class AntigravityDiscovery : IDiscovery
    {
        ...
        void FindInstallationPaths()
        {
            ...
            AddIfExists(installations, "Antigravity", "/Applications/Antigravity IDE.app");
            ...
            AddIfExists(installations, "Antigravity", $"{programFiles}/Antigravity IDE/Antigravity IDE.exe");
            AddIfExists(installations, "Antigravity", $"{programFilesX86}/Antigravity/Antigravity.exe");
            AddIfExists(installations, "Antigravity", $"{programFilesX86}/Antigravity IDE/Antigravity IDE.exe");
            AddIfExists(installations, "Antigravity", $"{localAppData}/Programs/Antigravity/Antigravity.exe");
            AddIfExists(installations, "Antigravity", $"{localAppData}/Programs/Antigravity IDE/Antigravity IDE.exe");
            ...
            AddIfExists(installations, "Antigravity", "/usr/bin/antigravity-ide");
            AddIfExists(installations, "Antigravity", "/usr/local/bin/antigravity-ide");
